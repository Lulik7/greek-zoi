 ...
 *
 * Если ключи Stripe не заданы, оплата картой не работает: сайт предлагает
 * написать школе, а подписку включают вручную в админке — тому, кто заплатил
 * переводом. Бесплатно доступ не открывается ни в каком случае.
 */
...
if (config.stripe.enabled) {
  ...
  console.log('[stripe] ключи не заданы — оплата картой выключена, подписку включают вручную');
}
