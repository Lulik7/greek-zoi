...
export default function HomePage() {
  ...
  usePageMeta(
    '',
    'Онлайн-школа греческого языка Зои Павловской: песни и диалоги с текстами и переводом, разбор по уровням от A1 до B2. Часть материалов открыта бесплатно.',
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Песни и другие аудиоматериалы, которые учат вас греческому языку
            </Typography>
